        ...
        <Card className="bg-mobs-lab-color text-white overflow-hidden">
          <div className="p-1 border-b border-gray-700 flex justify-between items-center">
            <h3 className="text-lg font-medium">
              {" "}
              Weighted Interval Score / Baseline{" "}
            </h3>
            <button
              onClick={() =>
                dispatch(
                  setWisChartScaleType(
                    wisChartScaleType === "log" ? "linear" : "log",
                  ),
                )
              }
              className="bg-blue-500 hover:bg-blue-600 text-white text-xs py-1 px-2 rounded"
            >
              {wisChartScaleType === "log"
                ? "Use Linear Scale"
                : "Use Log Scale"}
            </button>
          </div>
          ...
          <div className="p-1 border-b border-gray-700 flex justify-between items-center">
            ...
            <button
              onClick={() =>
                dispatch(
                  setMapeChartScaleType(
                    mapeChartScaleType === "log" ? "linear" : "log",
                  ),
                )
              }
              className="bg-blue-500 hover:bg-blue-600 text-white text-xs py-1 px-2 rounded"
            >
              {mapeChartScaleType === "log"
                ? "Use Linear Scale"
                : "Use Log Scale"}
            </button>
          </div>
...
const EvaluationsPage = () => {
  ...
  const defaultTab = isSeasonOverviewEnabled
    ? "single-model"
    : "season-overview";
