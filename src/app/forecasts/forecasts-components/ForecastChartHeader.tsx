...
const ForecastChartHeader: React.FC = () => {
    ...
    const chartInfo = (
        <div>
            ...
            <p>
                Use the toggle button on the upper-right corner to turn on/off historical surveillance data viewing
                mode.
            </p>
            <p>
    ...
    return (
        <div
            className="flex flex-row justify-between align-middle items-center px-4 overflow-ellipsis whitespace-nowrap">
            <div className="flex flex-shrink justify-start items-center">
                <h2 className="util-responsive-text util-text-limit mr-2"> Weekly Hospital Admissions
                    Forecast</h2>
