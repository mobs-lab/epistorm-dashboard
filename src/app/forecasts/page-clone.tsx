...
const Page: React.FC = () => {
    ...
    function addBackEmptyDatesWithPrediction(groundTruthData: DataPoint[], predictionsData: ModelPrediction[]): DataPoint[] {
        ...
        console.log("DEBUG: page.tsx: addBackEmptyDatesWithPrediction: states: ", states);
        ...
        /!*Step 3: Locate the actual most recent date from groundTruthData and check it against the last date in the newerDates set
                If the groundTruthData *!/
