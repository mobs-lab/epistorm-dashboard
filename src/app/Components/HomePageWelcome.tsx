    ...
    return (
        <div className="flex flex-col h-4/5 justify-between"> {/* Full screen height and flex container */}
            ...
            <div className="flex justify-center space-x-4 ">
                <Link href={"/forecasts"} className=" w-1/6 bg-blue-500 hover:bg-blue-700 text-white p-2 font-bold rounded">
                    View Forecasts
                </Link>
                <Link href={"/background"} className="w-1/6 bg-blue-500 hover:bg-blue-700 text-white p-2 font-bold rounded">
                    About us
                </Link>
            </div>
        </div>
